 ...
 */
if ( ! function_exists( 'christiaanconover_top_bar_l' ) ) {
	function christiaanconover_top_bar_l() {
	    wp_nav_menu(array(
 ...
 * Right top bar
 */
if ( ! function_exists( 'christiaanconover_top_bar_r' ) ) {
	function christiaanconover_top_bar_r() {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
 ...
 * Mobile off-canvas
 */
if ( ! function_exists( 'christiaanconover_mobile_off_canvas' ) ) {
	function christiaanconover_mobile_off_canvas() {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
...
*/
if ( ! function_exists( 'christiaanconover_add_menuclass' ) ) {
	function christiaanconover_add_menuclass($ulclass) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','christiaanconover_add_menuclass' );
}
 ...
 */
function christiaanconover_breadcrumb($showhome = true, $separatorclass = false) {
