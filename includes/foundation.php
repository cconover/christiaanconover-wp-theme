...
// Pagination.
if ( ! function_exists( 'christiaanconover_pagination' ) ) :
function christiaanconover_pagination() {
	global $wp_query;
...
if ( ! function_exists( 'christiaanconover_menu_fallback' ) ) :
...
if ( ! function_exists( 'christiaanconover_active_nav_class' ) ) :
function christiaanconover_active_nav_class( $classes, $item ) {
	if ( 1 == $item->current || true == $item->current_item_ancestor ) {
		$classes[] = 'active';
	}
	return $classes;
}
add_filter( 'nav_menu_css_class', 'christiaanconover_active_nav_class', 10, 2 );
endif;
 ...
 */
if ( ! function_exists( 'christiaanconover_active_list_pages_class' ) ) :
function christiaanconover_active_list_pages_class( $input ) {
...
add_filter( 'wp_list_pages', 'christiaanconover_active_list_pages_class', 10, 2 );
endif;
